import { Client, PlacePhotoResponse } from '@googlemaps/google-maps-services-js';
...
export const fetchPlaces = ({ 
  location='', 
  radius=0 
}: { location: LatLng; radius: number}): Promise<PlacesNearbyResponse> => 
...
export const fetchPhotos = ({ 
  ...
  maxwidth=1600, 
  maxheight=1600 
}: { photo: PlacePhoto; maxwidth: number; maxheight: number}): Promise<PlacePhotoResponse> => 
